...
class Paperlit_Utils
{
	...
	*/
	public static function search_files( $directory, $extension = '*', $recursive = false, &$out = array() ) {
		...
		try {
			...
			error_log( 'Paperlit error: ' . $e->getMessage() );
		}
	...
	*/
	...
	public static function make_dir( $basepath, $dir, $sanitize = true ) {
		...
		$path = $basepath . DS . ( $sanitize ? Paperlit_Utils::sanitize_string( $dir ) : $dir );
		if ( is_dir( $path ) ) {
			return $path;
		}
			...
			foreach ( $objects as $object ) {
				...
				if ( $object != "." && $object != ".." ) {
					...
					if ( filetype( $dir . DS . $object ) == "dir" ) {
						Paperlit_Utils::remove_dir( $dir . DS . $object );
					}
					else {
	...
	public static function sanitize_string($str) {
		...
		$replacements = array(
			...
			'"' 	=> '',
			'_'	=> '-',
            'à' => 'a', 'á' => 'a', 'â' => 'a', 'ã' => 'a',    'ä' => 'ae','&auml;' => 'ae',
            'å' => 'a', 'ā' => 'a', 'ą' => 'a', 'ă' => 'a','æ' => 'ae', 'ç' => 'c',
            'ć' => 'c', 'č' => 'c', 'ĉ' => 'c', 'ċ' => 'c','ď' => 'd', 'đ' => 'd', 
            'ð' => 'd', 'è' => 'e', 'é' => 'e', 'ê' => 'e','ë' => 'e', 'ē' => 'e', 
            'ę' => 'e', 'ě' => 'e', 'ĕ' => 'e', 'ė' => 'e','ƒ' => 'f', 'ĝ' => 'g', 
            'ğ' => 'g', 'ġ' => 'g', 'ģ' => 'g', 'ĥ' => 'h','ħ' => 'h', 'ì' => 'i', 
            'í' => 'i', 'î' => 'i', 'ï' => 'i', 'ī' => 'i','ĩ' => 'i', 'ĭ' => 'i', 
            'į' => 'i', 'ı' => 'i', 'ĳ' => 'ij', 'ĵ' => 'j','ķ' => 'k', 'ĸ' => 'k', 
            'ł' => 'l', 'ľ' => 'l', 'ĺ' => 'l', 'ļ' => 'l','ŀ' => 'l', 'ñ' => 'n', 
            'ń' => 'n', 'ň' => 'n', 'ņ' => 'n', 'ŉ' => 'n','ŋ' => 'n', 'ò' => 'o', 
            'ó' => 'o', 'ô' => 'o', 'õ' => 'o', 'ö' => 'oe','&ouml;' => 'oe', 
            'ø' => 'o', 'ō' => 'o', 'ő' => 'o', 'ŏ' => 'o', 'œ' => 'oe','ŕ' => 'r', 
            'ř' => 'r', 'ŗ' => 'r', 'š' => 's', 'ù' => 'u', 'ú' => 'u','û' => 'u', 
            'ü' => 'ue', 'ū' => 'u', '&uuml;' => 'ue', 'ů' => 'u', 'ű' => 'u',
