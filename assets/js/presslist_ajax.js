...
list = {
     ...
     * way around. We'll use the hidden inputs added in Paperlit_list::display()
    ...
    init: function() {
        ...
        $('#paperlit_metabox .inside').delegate('.tablenav-pages .pagination-links a, .manage-column.sortable a, .manage-column.sorted a','click', function(e) {
...
$('#doaction').on( "click", function(e) {
    ...
    e.preventDefault();
    var posts = new Array();
    var action_to_do = $('#paperlit_metabox .actions select option:selected').val();
    var el;
...
$( "#paperlit_metabox .inside" ).delegate(".number_element_input",'change', function(e) {
