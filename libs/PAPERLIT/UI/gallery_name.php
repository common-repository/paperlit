<?php
  ...
  ?>
  <script type="text/html" id="tmpl-paperlit-gallery-name">
    <label class="setting">
      ...
      wp.media.view.Settings.Gallery = wp.media.view.Settings.Gallery.extend({
        template: function(view){
          return wp.media.template('gallery-settings')(view)
               + wp.media.template('paperlit-gallery-name')(view);
        }
      });
  ...
  ?>
  <script type="text/html" id="tmpl-paperlit-playlist-name">
    <label class="setting">
      <span class="name"><?php _e('Name'); ?></span>
      <input style="float:none" class="size" type="text" data-setting="name">
    </label>
      ...
      wp.media.view.Settings.Playlist = wp.media.view.Settings.Playlist.extend({
        template: function(view){
          return wp.media.template('playlist-settings')(view)
               + wp.media.template('paperlit-playlist-name')(view);
        }
      });
