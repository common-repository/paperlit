<?php
abstract class Paperlit_Server_API
{
  /**
   * Sniff Requests
   * If $_GET['__paperlit-api'] is set, we kill WP and serve up pug bomb awesomeness
   *
  ...
  public function parse_request() {
    ...
    global $wp;
    if ( isset( $wp->query_vars['__paperlit-api'] ) ) {
      return $wp->query_vars['__paperlit-api'];
    }
  ...
  public function add_endpoint() {
    ...
    add_rewrite_tag('%__paperlit-api%', '([^&]+)');
