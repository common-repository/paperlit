...
list = {
    ...
    init: function() {
        ...
        $('.paperlit_page_paperlit-logs').delegate('.tablenav-pages .pagination-links a, .manage-column.sortable a, .manage-column.sorted a','click', function(e) {
...
$( ".paperlit_page_paperlit-logs" ).delegate(".number_element_input",'change', function(e) {
