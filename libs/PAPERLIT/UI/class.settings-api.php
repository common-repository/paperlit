...
class WeDevs_Settings_API {
    ...
    function callback_color( $args ) {
        ...
        $html .= sprintf( '<label class="color-check-label" for="check_%2$s_%3$s"><input type="checkbox" class="%1$s-checkbox paperlit-color-checkbox" id="check_%2$s_%3$s" data-picker="%2$s[%3$s]" name="check-%2$s[%3$s]" value="clear" %4$s />Transparent</label>', $size, $args['section'],  $args['id'], $check_value ? 'checked="checked"' : '' );
        $html .= $this->get_field_description( $args );
    ...
    function script() {
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                $('.paperlit-color-checkbox').change(function(){
